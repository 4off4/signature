...
public class SignatureUtil {
    public String getSignature(String securekey, String partnerNo, String amount, String currency) {
        String signatureString = "||" + securekey + "||" + partnerNo
                 + "||" + amount + "||" + currency + "||";
    ...
    public static void main(String[] args) {
        ...
        String result = util.getSignature("securekey", "MID001", "10000", "KRW");
